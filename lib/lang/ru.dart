const Map<String, String> ru = {
  ...
  'btn_official_site': 'Официальный сайт',
  ...
  'config_impostors': 'Самозванцы',
  'config_time': 'Время',
  'config_edit_punishments': 'Редактировать наказания',
  'config_btn_start': 'НАЧАТЬ ИГРУ',
...
const List<String> defaultPunishmentsRu = [
  "🍺 До дна! Выпейте всё",
  "💃 Танцуйте 30 секунд без музыки",
  "🏋️ Сделайте 10 присяданий",
  "📱 Пусть каждый прочтёт последнее сообщение",
